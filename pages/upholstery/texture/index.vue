<template>
  <div class="w-full">
    <div class="h-[70vh] w-full">
      <NuxtImg
        format="webp"
        src="/images/upholstery/Textured.jpg"
...
useHead({
  title: "Textured Upholstery Fabrics | Quality Textured Materials India",
  meta: [
    {
      name: "description",
      content:
...
onMounted(async () => {
  const colRef = collection($firestore, "upholsterytexture");

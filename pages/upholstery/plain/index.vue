<template>
  <div class="w-full">
    <div class="h-[70vh] w-full">
      <NuxtImg
        format="webp"
        src="/images/upholstery/Leather Look.png"
...
useHead({
  title: "Plain Upholstery Fabrics | High-Quality Plain Materials India",
  meta: [
    {
      name: "description",
      content:
...
onMounted(async () => {
  const colRef = collection($firestore, "upholsteryplain");

<template>
    <div class="w-full">
        <div class="h-[40vh]">
            <NuxtImg format="webp" src="/images/home-carousel/4.png" class="h-full w-full object-cover" alt="" />
        </div>

        <div class="lg:flex px-10 w-full justify-between pt-14 lg:pt-28 xl:px-20">
            <h2 class="text-5xl font-semibold">Curtains</h2>
...
const triggerSubmit = () => {
    ...
    router.push('/style-curtains/submit')
};
